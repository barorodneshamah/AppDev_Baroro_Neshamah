...
const styles = StyleSheet.create({
  ...
  logoImage: { width: 180, height: 130, borderRadius: 25, resizeMode: 'cover' },

  bottomSection: { flex: 1, paddingHorizontal: 30, paddingTop: 30, alignItems: 'center' },
  ...
  footerText: { color: COLORS.textDark, fontSize: 14, fontWeight: 'bold' },
